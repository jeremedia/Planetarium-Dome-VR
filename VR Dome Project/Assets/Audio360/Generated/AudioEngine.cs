...
public class AudioEngine : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef getCPtr(AudioEngine obj) {
  ...
  public virtual void setListenerRotation(TBVector forward, TBVector upVector) {
    Audio360CSharpPINVOKE.AudioEngine_setListenerRotation__SWIG_0(swigCPtr, TBVector.getCPtr(forward), TBVector.getCPtr(upVector));
  ...
  public virtual void enablePositionalTracking(bool enable, TBVector initialListenerPosition) {
    Audio360CSharpPINVOKE.AudioEngine_enablePositionalTracking(swigCPtr, enable, TBVector.getCPtr(initialListenerPosition));
    if (Audio360CSharpPINVOKE.SWIGPendingException.Pending) throw Audio360CSharpPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public virtual EngineError setOutputLatency(uint numOfBuffers) {
    EngineError ret = (EngineError)Audio360CSharpPINVOKE.AudioEngine_setOutputLatency(swigCPtr, numOfBuffers);
    return ret;
  }

  public virtual uint getOutputLatency() {
    uint ret = Audio360CSharpPINVOKE.AudioEngine_getOutputLatency(swigCPtr);
    return ret;
  }
  ...
  public NativeAudioObject createAudioObject() {
    global::System.IntPtr cPtr = Audio360CSharpPINVOKE.AudioEngine_createAudioObject(swigCPtr);
  ...
  public void setEventListener(NativeEventListener listener) {
    Audio360CSharpPINVOKE.AudioEngine_setEventListener(swigCPtr, NativeEventListener.getCPtr(listener));
  }
