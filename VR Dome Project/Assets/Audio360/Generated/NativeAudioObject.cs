...
public class NativeAudioObject : SpatDecoderInterface {
  ...
  public virtual void setPosition(TBVector position) {
    Audio360CSharpPINVOKE.NativeAudioObject_setPosition(swigCPtr, TBVector.getCPtr(position));
    if (Audio360CSharpPINVOKE.SWIGPendingException.Pending) throw Audio360CSharpPINVOKE.SWIGPendingException.Retrieve();
  }

  public virtual TBVector getPosition() {
    TBVector ret = new TBVector(Audio360CSharpPINVOKE.NativeAudioObject_getPosition(swigCPtr), true);
    return ret;
  }

  public void setEventListener(NativeEventListener listener) {
    Audio360CSharpPINVOKE.NativeAudioObject_setEventListener(swigCPtr, NativeEventListener.getCPtr(listener));
  }
