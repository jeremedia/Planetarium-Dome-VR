...
public class NativeSpatDecoderFile : SpatDecoderInterface {
  ...
  public virtual EngineError stop() {
    EngineError ret = (EngineError)Audio360CSharpPINVOKE.NativeSpatDecoderFile_stop(swigCPtr);
    return ret;
  }

  public virtual EngineError stopScheduled(float millisecondsFromNow) {
    EngineError ret = (EngineError)Audio360CSharpPINVOKE.NativeSpatDecoderFile_stopScheduled(swigCPtr, millisecondsFromNow);
    return ret;
  }

  public virtual EngineError stopWithFade(float fadeDurationInMs) {
    EngineError ret = (EngineError)Audio360CSharpPINVOKE.NativeSpatDecoderFile_stopWithFade(swigCPtr, fadeDurationInMs);
    return ret;
  }
  ...
  public void setEventListener(NativeEventListener listener) {
    Audio360CSharpPINVOKE.NativeSpatDecoderFile_setEventListener(swigCPtr, NativeEventListener.getCPtr(listener));
  }
