...
public class TBQuat : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef getCPtr(TBQuat obj) {
  ...
  public static TBQuat getQuatFromEulerAngles(float xRotation, float yRotation, float zRotation) {
    TBQuat ret = new TBQuat(Audio360CSharpPINVOKE.TBQuat_getQuatFromEulerAngles(xRotation, yRotation, zRotation), true);
    return ret;
  }
